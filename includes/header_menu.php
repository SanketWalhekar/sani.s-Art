<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">Sani.s Art</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#pencil" class="dropdown-item">Pencil Sketch</a>
                                   <a href="products.php#acrylic" class="dropdown-item">Acrylic Paintings</a>
                                   <a href="products.php#canvas" class="dropdown-item">Canvas Paintings</a>
                                   <a href="products.php#nature" class="dropdown-item">Nature Sketch</a>
                               </div>
                           
                       </li>
                       <li class="nav-item"><a href="index.php" class="nav-link">Offers</a></li>
                       <li class="nav-item"><a href="page.php" class="nav-link">Sketch Order</a></li>
